...
<div class="l-container">
  <div class="p-record">
    <div class="p-record__form">
      ...
      <form action="{{ route('worktime-update', ['id' => $worktimeRecord->id]) }}" method="POST">
        @csrf
        {{-- 申請日 --}}
        <section class="p-record__date">
          ...
          <div class="p-record__body">
            <input type="date" name="record_date" id="" class="@error('record_date') is-invalid @enderror"
              value="{{ old('record_date', $worktimeRecord->record_date) }}">
            @error('record_date')
              ...
              <div class="p-record__time-select">
                ...
                <div class="p-record__time-start">
                  ...
                  <select name="weekday_morning_start" id="" class="c-cp_ipselect c-cp_sl02">
                    ...
                    <option value="{{date('H:i:s',$value)}}" @if (date('H:i:s',$value) == old('weekday_morning_start',$worktimeRecord->weekday_morning_start))
                ...
                <div class="p-record__time-end">
                  ...
                  <select name="weekday_morning_end" id="" class="c-cp_ipselect c-cp_sl02">
                    ...
                    <option value="{{date('H:i:s',$value)}}" @if (date('H:i:s',$value) == old('weekday_morning_end',$worktimeRecord->weekday_morning_end)) selected
              ...
              <div class="p-record__time-select">
                ...
                <div class="p-record__time-start">
                  ...
                  <select name="weekday_normal_start" id="" class="c-cp_ipselect c-cp_sl02">
                    ...
                    <option value="{{date('H:i:s',$value)}}" @if (date('H:i:s',$value) == old('weekday_normal_start',$worktimeRecord->weekday_normal_start))
                      selected @endif v-bind:disabled="disabledWeekday">{{date('H:i',$value)}}</option>
                    @endforeach
                  </select>
                </div>
                ...
                <div class="p-record__time-end">
                  ...
                  <select name="weekday_normal_end" id="" class="c-cp_ipselect c-cp_sl02">
                    ...
                    <option value="{{date('H:i:s',$value)}}" @if (date('H:i:s',$value) == old('weekday_normal_end',$worktimeRecord->weekday_normal_end)) selected
                      @endif v-bind:disabled="disabledWeekday">{{date('H:i',$value)}}</option>
                    @endforeach
                  </select>
                </div>
              ...
              <div class="p-record__time-select">
                ...
                <div class="p-record__time-start">
                  ...
                  <select name="weekday_midnight_start" id="" class="c-cp_ipselect c-cp_sl02">
                    ...
                    <option value="{{date('H:i:s',$value)}}" @if (date('H:i:s',$value) == old('weekday_midnight_start',$worktimeRecord->weekday_midnight_start))
                      selected @endif v-bind:disabled="disabledWeekday">{{date('H:i',$value)}}</option>
                    @endforeach
                  </select>
                </div>
                ...
                <div class="p-record__time-end">
                  ...
                  <select name="weekday_midnight_end" id="" class="c-cp_ipselect c-cp_sl02">
                    ...
                    <option value="{{date('H:i:s',$value)}}" @if (date('H:i:s',$value) == old('weekday_midnight_end',$worktimeRecord->weekday_midnight_end))
                      selected @endif v-bind:disabled="disabledWeekday">{{date('H:i',$value)}}</option>
                    @endforeach
                  </select>
                </div>
              ...
              <div class="p-record__time-select">
                ...
                <div class="p-record__time-start">
                  ...
                  <select name="holiday_start" id="" class="c-cp_ipselect c-cp_sl02">
                    ...
                    <option value="{{date('H:i:s',$value)}}" @if (date('H:i:s',$value) == old('holiday_start',$worktimeRecord->holiday_start)) selected
                ...
                <div class="p-record__time-end">
                  ...
                  <select name="holiday_end" id="" class="c-cp_ipselect c-cp_sl02">
                    ...
                    <option value="{{date('H:i:s',$value)}}" @if (date('H:i:s',$value) == old('holiday_end',$worktimeRecord->holiday_end)) selected @endif
              ...
              <div class="p-record__time-select">
                ...
                <div class="p-record__time-start">
                  ...
                  <select name="holiday_midnight_start" id="" class="c-cp_ipselect c-cp_sl02">
                    ...
                    <option value="{{date('H:i:s',$value)}}" @if (date('H:i:s',$value) == old('holiday_midnight_start',$worktimeRecord->holiday_midnight_start))
                ...
                <div class="p-record__time-end">
                  ...
                  <select name="holiday_midnight_end" id="" class="c-cp_ipselect c-cp_sl02">
                    ...
                    <option value="{{date('H:i:s',$value)}}" @if (date('H:i:s',$value) == old('holiday_midnight_end',$worktimeRecord->holiday_midnight_end))
        ...
        <section class="p-record__reason">
          ...
          <div class="p-record__body">
            <textarea name="work_content" id="" rows="3" placeholder="超勤理由を入力してください"
              class="p-record__reason-text @error('work_content') is-invalid @enderror">{{old('work_content', $worktimeRecord->work_content)}}</textarea>
            @error('work_content')
            <span class="invalid-feedback" role="alert" style="position: relative;top:-18px;">
              <strong>{{ $message }}</strong>
            </span>
